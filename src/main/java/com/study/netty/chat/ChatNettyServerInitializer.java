...
public class ChatNettyServerInitializer extends ChannelInitializer<SocketChannel> {
    protected void initChannel(SocketChannel sc) throws Exception {
        ...
        // DelimiterBasedFrameDecoder(maxFrameLength, delimiters)：分隔符处理器
        // 将接收到的客户端消息，通过回车符（Delimiters.lineDelimiter()）进行分割。
        ...
        // 自定义处理器
        pipeline.addLast("MyNettyServerHandler", new ChatNettyServerHandler());
    }
}
